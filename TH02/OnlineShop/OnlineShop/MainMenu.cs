...
namespace OnlineShop
{
    public partial class MainMenu : Form
    {
        ...
        {
            showSubMenu(panel_Price);
            if (panel_Price.Visible == true)
            {
                ptr_Price.BackgroundImage = Image.FromFile(@"..//..//Icon/downarrow.png");
            }
            else
            {
                panel_Price.Visible = false;
                ptr_Price.BackgroundImage = Image.FromFile(@"..//..//Icon/rightarrow.png");
            }
        }

        public double Price(string x)
        {
            return Convert.ToDouble(x.Replace(".", "").Replace(" VNĐ", ""));
        }
