...
{
    public partial class Fruit_Spelling : Form
    {
        public Fruit_Spelling()
        {
            InitializeComponent();
        }
        ...
        private void btn_ComeBack_MouseMove(object sender, MouseEventArgs e)
        {
            btn_ComeBack.BackColor = Color.LightBlue;
        }

        private void btn_ComeBack_MouseLeave(object sender, EventArgs e)
        {
            btn_ComeBack.BackColor = Color.Transparent;
        }
        ...
        public void NextQuestion()
        {
            ...
            picWord.BackgroundImage = Image.FromFile(@"..\\..\\Images\Fruits\" + pic);
            lbl_Answer.Text = ans;
